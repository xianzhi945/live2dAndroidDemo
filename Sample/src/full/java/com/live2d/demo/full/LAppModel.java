...
import static com.live2d.demo.LAppDefine.DEBUG_LOG_ENABLE;
...
//         前回セーブされた状態をロード
        ...
        isMotionUpdated |= rightArmMotionManager.updateMotion(model, deltaTimeSeconds); // 追加
        isMotionUpdated |= leftArmMotionManager.updateMotion(model, deltaTimeSeconds); // 追加
...
//    }
    ...
    public void setRandomExpression() {
        ...
        if (DEBUG_LOG_ENABLE) {
            LAppPal.printLog("expressions size: " + expressions.size());
        }
        int i = 0;
